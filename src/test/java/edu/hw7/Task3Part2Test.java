...
public class Task3Part2Test {
    ...
    public void testPersonAvailability() {
        Task3Part2.PersonDatabase personDatabase = new Task3Part2.LockedPersonDatabase();

        Task3Part2.Person person = new Task3Part2.Person(1, NAME, ADDRESS, PHONE_NUMBER);
    ...
    public void testPersonNotAvailable() {
        ...
        Task3Part2.Person person = new Task3Part2.Person(2, NAME, ADDRESS, PHONE_NUMBER);
        personDatabase.add(person);
